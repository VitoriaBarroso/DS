...
public carros() {
	...
	Color minhaCor = new Color(210,221,233);
	...
	lbLogo.setText("<html><font color = 'black'> ORÇAMENTO </font></html> ");
	add(lbLogo);
			...
			btoSalvar.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					JOptionPane.showMessageDialog(null, "Nome:" + nome + "/nNum Celular:" + cel + "/nEmail:" + email + "/nMarca:" + marca + 
							"/nModelo:" + modelo +  "/ncor" + cor ); 
				}
