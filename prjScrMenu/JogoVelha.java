...
public class JogoVelha extends JDialog {
	...
	private JLabel img;	
	 ...
	 //private String ganhador = null;
	
	 public void jogoTabuleiro() {
		 
		 	// horizontal //
	 		if((tabuleiro[0][0].equalsIgnoreCase("X") && tabuleiro[0][1].equalsIgnoreCase("X") && tabuleiro[0][2].equalsIgnoreCase("X")) || 
	 					(tabuleiro[0][0].equalsIgnoreCase("O") && tabuleiro[0][1].equalsIgnoreCase("O") && tabuleiro[0][2].equalsIgnoreCase("O"))){
	...
	public JogoVelha(){ 
		...
		lbOpcoes = new JLabel("Esse é o seu simbulo");
		...
		// se confimar que esse é o nome nao pode mudar //
		BotaoPronto bto = new BotaoPronto();
		btoPronto = new JButton("Pronto"); 
		btoPronto.setBounds(20,200,100,25);
		...
		//btoAvance.addActionListener(evb);
		...
		btoPronto2.setBounds(20,200,100,25);
		...
		// avancar p\ guia 2 //
		btoAvance2 = new JButton("Avançar"); 
		...
		btoRecomecar.setBounds(400,200,129,25);
	    ...
	    // primeiro if vai ser checado se é ou nao nulo se nao for ele o sistema para e se for ele continua//
			...
			public void actionPerformed(ActionEvent e) {
				if (tabuleiro[0][0] != null) {
					...
					if (jogadorAtual == "X") {
						...
						//op.setBounds(20,50,100,100);
						ImageIcon img = new ImageIcon("src/X.png"); // TIRAR DPS O GIF P\ ENTREGA !!!!! //
						op.setIcon(img);
						jogadorAtual = "O";
					}else {
						tabuleiro[0][0] = jogadorAtual;
